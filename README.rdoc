...
This client uses HTTPBasic Auth with email/password and does NOT rely on oAuth yet.
This authentication method might be kicked in the future, as oAuth2 is considered
safer. We are working on showing how to use this client with oAuth2
